...
import './Banner.css';
import hero from '../../../Images/insurance.webp'
                ...
                <Container>
                    <Row className="align-items-center">
                        <Col md={12} sm={12} lg={6}>
                            <div className="hero-slide-left justify-content-end align-items-center text-center text-lg-start mt-32">
                        ...
                        <Col md={12} sm={12} lg={6} className="mt-sm-5">
                            <div className="hero-slide-right text-center text-lg-start mt-sm-5 relative">
                                ...
                                <img src={hero} alt="" className="heroTeeth ml-52 rounded-lg"/>
                            </div>
                        </Col>
                    </Row>
                </Container>
