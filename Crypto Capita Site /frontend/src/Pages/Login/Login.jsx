                                ...
                                <div className="md:row flex justify-center">
                                    <div className="">
                                        <div className=" p-md-5 ">
                                            ...
                                            {/* <img  src={logoo} alt="Logo" style={{ width: '250px', height: '250px' }}/> */}
                                        

                                             
                                           
                                                <h1 className="mt-1 mb-5 pb-1">We are The CryptoCapita Team</h1>
                                            </div>
                                            <p className="flex justify-center items-center">Please connect your wallet</p>
